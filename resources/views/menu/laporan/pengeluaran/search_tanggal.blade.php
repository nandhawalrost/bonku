  ...
  <div class="box-header">
    <div class="box-body table-responsive">
      ...
      <table class = "table table-bordered table-hover table-sm" border="0" cellpadding="" cellspacing="">
        ...
        <tbody>
          @foreach($search_pengeluaran_tanggal_ini as $pengeluaran)
          <tr>
      ...
      {{ $search_pengeluaran_tanggal_ini->links() }}
    </div>
    <label><b>Total Pengeluaran: {{$sum_pengeluaran_tanggal_ini}}</b></label>
        ...
        <div class="modal fade" id="cariTanggal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <!-- search form -->
              <form class="form" action="/standard_user/menu/laporan/pengeluaran/pengeluaran_harian/search_tanggal" method="GET">
